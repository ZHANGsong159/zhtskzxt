<template>
  <div class="mainBody">
    ...
    <div class="tittle zIndex30">
      <xlghkzxtTittle :bosShow='bosShow'></xlghkzxtTittle>
    </div>
    <div class="body">
        <pinpuBOX></pinpuBOX>
    </div>
...
import pinpuBOX from "../components/xlghkzxt/components/pinpuPage/pinpuBox.vue";
...
.mainBody {
  ...
  .body {
    ...
    align-items: center;
    background:url('@/assets/img/5486320_2522435_@1x.png');
  }
  /* 渐变遮罩层 */
  .mask {
    position: absolute;
